...
The static site for [agentfacts.dev](https://agentfacts.dev) lives in [`site/`](./site/). Publish with `pnpm ship` (Wrangler Worker `agent-facts`, uploads `site/` as static assets, no build step).
